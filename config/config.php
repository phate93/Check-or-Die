...
|
*/
$config['botToken'] = "7795961418:AAFslv1QhHylLbezKHP_dpdmXX7JfjqV84U";
...
|
*/
$config['timeZone'] =  "Asia/Mexico_City";
...
$config['db']['username'] =  "sql3736972";
$config['db']['password'] =  "NaBv87ZE13";
$config['db']['database'] =  "sql3736972";
